...
CMyTimer::CMyTimer(const float fps): m_FPS(fps),
						               m_TimeElapsed(0.0f),
						               m_LastTime(0),
						               m_PerfCountFreq(0)
{
...
//
//----------------------------------------------------------------------------
bool CMyTimer::ReadyForNextFrame()
{
	if (!m_FPS)
  {
		AfxMessageBox(_T("No FPS set in timer Doh!"));
